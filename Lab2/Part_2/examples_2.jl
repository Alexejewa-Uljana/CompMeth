...
function detailed_extended_analysis(sol1, sol2)
    ...
    println("   Хорошо обусловленные: alpha = 0.01-0.05")
    println("   Плохо обусловленные: alpha = 0.1-0.5 (больше регуляризации!)")
    println("   Всегда тестировать несколько значений alpha")
    println("   Проверять устойчивость решений")
end
